...
- **Kimi**: Supports Kimi K3 (`kimi-k3`), Kimi K2.7 Code (`kimi-k2.7-code`), Kimi K2.7 Code HighSpeed (`kimi-k2.7-code-highspeed`), Kimi K2.6 (`kimi-k2.6`), and Kimi K2.5 (`kimi-k2.5`) with vision support. Kimi K3 currently requires `reasoning_effort: 'max'`; Kimi K2.7 Code models require thinking mode.
