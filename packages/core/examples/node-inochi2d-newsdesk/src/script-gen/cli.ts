...
import {
  AVATAR_MOTION_PATH_PLACEHOLDER,
  AVATAR_PATH_PLACEHOLDER,
  INOCHI2D_RUNTIME_PATH_PLACEHOLDER,
  promptPath,
} from '../paths.js';
...
/** Replace model paths with explicit local-file placeholders. */
export function normalizeScriptForOutput(
  ...
  return {
    ...script,
    avatar: AVATAR_PATH_PLACEHOLDER,
    avatarMotion: AVATAR_MOTION_PATH_PLACEHOLDER,
    inochi2dRuntime: INOCHI2D_RUNTIME_PATH_PLACEHOLDER,
  };
}
