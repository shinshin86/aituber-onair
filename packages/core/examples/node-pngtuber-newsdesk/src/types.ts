...
export interface NewsdeskScript {
  /** Four-state PNGTuber avatar directory, relative to the script file. */
  avatar?: string;
 ...
 * `<name>.pngtuber-gen.config.json`. `--render-only` re-reads it.
 */
export interface RenderConfig {
  ...
  blinkSeed: number;
  /** Absolute four-state PNGTuber avatar directory. */
  avatar: string;
