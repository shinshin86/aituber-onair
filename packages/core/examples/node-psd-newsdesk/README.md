...
Motion samples reference the official Miko motion-capable PSD from the sibling
...
The motion samples reference the official Miko PSD at
`../../react-psd-app/public/avatar/miko-anime25drig-cheer.psd`. This package
does not copy it; the asset remains subject to the Miko terms below.
...
does not copy them. The sibling Miko PSD remains subject to the asset terms
below.
