...
- Reads expression names from the selected model JSON and lets you map response
  emotions to them in **Settings → 感情表現エフェクト**
- Supports disabled, manual preview, and response-emotion-linked expression
  control; linked expressions start before TTS playback
