...
async function main() {
  ...
  try {
    ...
    await voiceService2.speakText('[happy] こんにちは！Node.jsから音声合成のテストです。');
  ...
  if (hasAudioLibrary) {
    ...
    console.log('ℹ Skipping audio playback test (install speaker or play-sound to enable)\n');
  }

  console.log('=== Summary ===');
  console.log('To enable all features:');
  console.log('1. Install and run VOICEVOX server (https://voicevox.hiroshiba.jp/)');
  console.log('2. Install audio libraries: npm install speaker OR npm install play-sound');
